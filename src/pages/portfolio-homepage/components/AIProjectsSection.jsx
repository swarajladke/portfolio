  ...
  const aiProjects = [
    {
      ...
      image: 'https://27.group/wp-content/uploads/2021/03/DT-Feature.png',
      ...
      publications: [
       'International Journal of Sciences and Innovation Engineering (Published)',
       'Available Online at : www.ijsci.com'
      ],
      metrics: {
